document.addEventListener('DOMContentLoaded', () => {
  /* ============================================================
     1. NAVEGAÇÃO SUAVE E BOTÕES DE ANCORAGEM (Scroll até o Topo e Seções)
     ============================================================ */
  ...
  anchorLinks.forEach(link => {
    link.addEventListener('click', (e) => {
      ...
      // Se o href for apenas "#", ignora para não quebrar
      if (targetId === '#') return;
      ...
      if (targetElement) {
        ...
        // Atualiza a URL sem dar "pulo" na tela
  ...
  /* ============================================================
     2. GERAÇÃO DINÂMICA DO QR CODE (Compatível com GitHub Pages)
     ============================================================ */
  const qrImg = document.getElementById('qrCodeImg');
  
  if (qrImg) {
    // Garante o link completo e trata caracteres especiais da URL
    const currentUrl = encodeURIComponent(window.location.href);
    
    // API pública de alta disponibilidade para geração do QR Code
    qrImg.src = `https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${currentUrl}`;
  }

  /* ============================================================
     3. LÓGICA DO CARROSSEL SIMULADOR
     ============================================================ */
  ...
  if (track && slides.length > 0 && dotsContainer) {
    ...
    // Limpa pontinhos existentes antes de recriar
  ...
  /* ============================================================
     4. LÓGICA DO QUIZ INTERATIVO (10 Questões sem Erros de Execução)
     ============================================================ */
  const quizData = [
    {
